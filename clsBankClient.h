   ...
   static stTrnsferLogRecord _ConvertTransferLogLineToRecord(string Line, string Separator = "#//#")
    {
        ...
        vTransferLogData = clsString::Split(Line, Separator);
        stTrnsferLogRecord TransferLogRecord;
        TransferLogRecord.DateTime = vTransferLogData[0];
        TransferLogRecord.SourceAccount = vTransferLogData[1];
        TransferLogRecord.DestinationAccount = vTransferLogData[2];
